...
declare module angular.material {
    ...
    interface MDIconProvider {
        icon(id: string, url: string, iconSize?: number): MDIconProvider; // iconSize default: '24px'
        iconSet(id: string, url: string, iconSize?: number): MDIconProvider; // iconSize default: '24px'
        defaultIconSet(url: string, iconSize?: string): MDIconProvider; // iconSize default: '24px'
        defaultIconSize(iconSize: number): MDIconProvider; // default: '24px'
    }
    ...
    interface MDGestureProvider {
        skipClickHijack(): void;
    }
}
